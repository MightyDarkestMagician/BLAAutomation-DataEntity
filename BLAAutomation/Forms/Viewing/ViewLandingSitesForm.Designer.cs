partial class ViewLandingSitesForm
{
    ...
    private System.Windows.Forms.DataGridView landingSiteDataGridView;
    ...
    private void InitializeComponent()
    {
        ...
        this.landingSiteDataGridView = new System.Windows.Forms.DataGridView();
        ((System.ComponentModel.ISupportInitialize)(this.landingSiteDataGridView)).BeginInit();
        this.SuspendLayout();
        // 
        // filterField
        // 
        this.filterField.Depth = 0;
        this.filterField.Hint = "Модель БЛА";
        ...
        // 
        // landingSiteDataGridView
        // 
        this.landingSiteDataGridView.AllowUserToAddRows = false;
        this.landingSiteDataGridView.AllowUserToDeleteRows = false;
        this.landingSiteDataGridView.AutoSizeColumnsMode = System.Windows.Forms.DataGridViewAutoSizeColumnsMode.Fill;
        this.landingSiteDataGridView.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
        this.landingSiteDataGridView.Dock = System.Windows.Forms.DockStyle.Top;
        this.landingSiteDataGridView.Location = new System.Drawing.Point(0, 0);
        this.landingSiteDataGridView.Name = "landingSiteDataGridView";
        this.landingSiteDataGridView.ReadOnly = true;
        this.landingSiteDataGridView.Size = new System.Drawing.Size(800, 300);
        this.landingSiteDataGridView.TabIndex = 6;
        // 
        // ViewLandingSitesForm
        // 
        this.ClientSize = new System.Drawing.Size(800, 450);
        this.Controls.Add(this.landingSiteDataGridView);
        ...
        this.Name = "ViewLandingSitesForm";
        this.Load += new System.EventHandler(this.ViewLandingSitesForm_Load);
        ((System.ComponentModel.ISupportInitialize)(this.landingSiteDataGridView)).EndInit();
