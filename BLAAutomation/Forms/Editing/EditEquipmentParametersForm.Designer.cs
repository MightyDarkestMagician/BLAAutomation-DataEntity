partial class EditEquipmentParametersForm
{
    ...
    private void InitializeComponent()
    {
        ...
        this._saveButton.Click += new System.EventHandler(this.SaveEquipment);

        // 
        // EditEquipmentParametersForm
        // 
        ...
        this.Name = "EditEquipmentParametersForm";
        this.Text = "Редактировать оборудование";
        this.Load += new System.EventHandler(this.EditEquipmentParametersForm_Load);
